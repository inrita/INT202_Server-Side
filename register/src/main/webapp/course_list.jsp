...
<%--อ้าง project ผ่าน web แทนภานในเครื่องเพื่อแสดง css ได้--%>
</head>

<%--เรียกใช้ servlet 2 ตัว คือ course_list และ register--%>
<body>
<div class="container m-auto bg-light w-75">
    <div class="row w-100 h2">Course List ::</div>
    <div class="row w-100">
        <form class="form-inline" action="course_list" method="post">
                    ...
                    <div class="row bg-transparent">
                        ...
                        <div class="col-1">
                            <input type="checkbox" name="registeredSubjects" value="${subject.subjectId}"
                                ${semesterRegistered != null ? semesterRegistered[subject.subjectId]: ''}/>
                        </div>
                    </div>
                </c:forEach>
                <hr>
